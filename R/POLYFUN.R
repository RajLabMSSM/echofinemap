...
#' \describe{
#' \item{precomputed}{Using precomputed prior causal probabilities based on
#' a meta-analysis of 15 UK Biobank traits. The meta-analysis was performed
#' as part of the original
#' \href{https://www.nature.com/articles/s41588-020-00735-5}{
#' PolyFun publication}.}
#' \item{parametric}{Computing prior causal probabilities via an
#' L2-regularized extension of stratified LD-score regression (S-LDSC).
#' This is a relatively simple approach, but the prior causal probabilities
#' may not be robust to modeling misspecification.
#' Gathered from the "*.snpvar_ridge_constrained.gz" output files
#' from PolyFun.}
#' \item{non-parametric}{Computing prior causal probabilities
#' non-parametrically. This is the most robust approach, but it is
#' computationally intensive and requires access to individual-level
#' genotypic data from a large reference panel (optimally >10,000
#' population-matched individuals).
